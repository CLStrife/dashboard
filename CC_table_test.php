...
<body>
	...
	<script type="text/javascript">
		...
		function charger(){
			...
			xhr.open("GET", "agents2.php", true); //methode de la requete, appel du fichier
			xhr.send();
		...
		function changeNb(){
			setTimeout(function(){
			var nb = Math.floor((Math.random()*50)+5);
			document.getElementById('random').innerHTML = nb;
		changeNb()	
		}, 3000);
